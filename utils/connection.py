...
def get_jwt_token(host: str | None = None, key: str | None = None, *, timeout: int = 10) -> Optional[str]:
    ...
    try:
        ...
        logger.error("Authentication succeeded but token field missing in response: %s", data)
